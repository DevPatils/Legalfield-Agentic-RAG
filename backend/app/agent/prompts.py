...
- out_of_scope     -- not answerable from contract text (greetings, general knowledge,
                      legal advice, facts about the world, questions about companies
                      rather than about their agreements)

needs_retrieval:
- false for greetings, meta-questions about your own capabilities, and out_of_scope
- true otherwise
